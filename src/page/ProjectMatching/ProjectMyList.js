...
function ProjectMyList() {
              ...
              >
                ...
                <div class="w-grow">
                  <div class="w-32 h-32 mb-2">
                    <img
                      src={
                        "data:image/" + item.imgType + ";base64," + item.image
                      }
              ...
              >
                <div class="w-[47rem] py-2">
                  <div class="text-sm text-gray-400 flex gap-2 items-center font-ltest">
                    ...
                    <div class="text-sm font-ltest text-gray-400 mt-1">
                      {item.startDate + " ~ " + item.endDate}
                    </div>
                  </div>
                  <button
  ...
  return (
    <div class="bg-white w-full font-test">
      ...
      {showApplyingModal ? (
        <ApplyingModal setShowApplyingModal={setShowApplyingModal} />
      ) : null}
        ...
        <div class="relative my-10">
          ...
          <div class="flex justify-around text-2xl font-btest mx-10 items-center mt-5">
            <button
              class={
                showRecruiting
                  ? "px-3 border-b-4 border-indigo-300 pb-5"
                  : "px-3 pb-5 border-b-4 border-white"
              }
              onClick={() => {
